        ...
        parseDatesDraw: function() {
            ...
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    m = l = p;
                    if (!isNaN(w))
                        for (h = 1; h < u; h += w) this.gridAlpha = this.minorGridAlpha, f = p + y * h, f = d.resetDateToMin(new Date(f), A, w, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) *
                ...
                if (e.valueAxis == this) {
                    ...
                    if (!isNaN(a.startTime) && (m = a.categoryAxis)) {
                        var n = m.minDuration(),
                            ...
                            q = d.resetDateToMin(new Date(a.startTime),
                                m.minPeriod).getTime();
                                ...
                                if (t) {
                                    ...
                                    if (R < n && 0 < K) {
                                        ...
                                        var ua = new d.Cuboid(h, K, ba, H,
                                                S, Ma, Va, da, Ca, X, ga, w, t, ea, bb, mb, aa),
                                            Fb, Gb;
            ...
            if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                ...
                if (p) {
                    ...
                    if ("serial" == e.type || "gantt" == e.type)
                        if (-.5 > b || b > this.width || c < -g / 2 || c > this.height) p.remove(),
                            p = null;
        ...
        fixVLine: function(a, b) {
            if (!isNaN(a)) {
                ...
                this.prevLineX != a && (c = this.animationDuration, this.zooming && (c = 0), this.vvLine.stop(), this.vvLine.animate({
                        translate: a + "," + b
                    }, c, "easeOutSine"), this.prevLineX = a, this.prevLineY =
                    b)
            }
        },
        fixHLine: function(a, b) {
            if (!isNaN(a)) {
                ...
                this.prevLineY != a && (c = this.animationDuration, this.zooming && (c = 0), this.hhLine.stop(), this.hhLine.animate({
                        translate: b + "," + a
                    }, c, "easeOutSine"), this.prevLineY = a, this.prevLineX =
                    b)
            }
        },
                    ...
                    if (this.resizingLeft) {
                        if (m)
                            if (c = e, e = r, e < f && (e = f), isNaN(e) && (e = f), e > p + f && (e = p + f), a = !0 === b ? c - e : k + c - e, !isNaN(this.maxHeight) && a > this.maxHeight && (a = this.maxHeight, e = c), 0 > a) this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("y", c + k - f);
                                ...
                                e = c), 0 > a) this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("x", c + l - d);
                        else {
                            if (0 === a || isNaN(a)) a = .1;
                            g.setAttr("x", e - d);
                            g.setAttr("width", a)
