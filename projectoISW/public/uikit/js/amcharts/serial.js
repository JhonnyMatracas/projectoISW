    ...
    e.Cuboid = e.Class({
        ...
        draw: function() {
            ...
            if (0 < Math.abs(h) || 0 < Math.abs(f))
                if (isNaN(q)) z = t, t = e.adjustLuminosity(v, -.2), t = e.adjustLuminosity(v, -.2), x = e.polygon(b, [0, h, d + h, d, 0], [0, f, f, 0, 0],
            ...
            d = isNaN(q) ? 0 > g ? [x,
                M, B, A, G, D, C, z, L, b
            ] : [z, L, B, A, G, D, x, M, C, b] : K ? 0 < d ? [x, b, z] : [z, b, x] : 0 > g ? [x, b, z] : [z, b, x];
            e.setCN(c, b, E + "front");
            e.setCN(c, B, E + "back");
            e.setCN(c, z, E + "top");
